...
# from api_spec_converter_py.utils import parse_json, parse_yaml # Assuming these will be in utils
...
class Swagger2Format(BaseFormat):
    ...
    def fix_spec(self):
        ...
        # from api_spec_converter_py.utils.utils import remove_none_values
